...
public class ExcelExperimentalResultsDTO {
    ...
    @ExcelProperty(value = "实验信息-内存访问时间", index = 7)
    @ColumnWidth(18)
    private Integer memoryAccessTime;

    @ExcelProperty(value = "实验信息-快表访问时间", index = 8)
    @ColumnWidth(18)
    private Integer fastTableAccessTime;

    @ExcelProperty(value = "实验信息-缺页时间", index = 9)
    @ColumnWidth(18)
    ...
    @ExcelProperty(value = "实验结果-记录ID", index = 11)
    @ColumnWidth(15)
    private Integer id;

    @ExcelProperty(value = "实验结果-算法类型", index = 12)
    @ColumnWidth(18)
    private String algorithmType;

    @ExcelProperty(value = "实验结果-关联实验ID", index = 13)
    @ColumnWidth(18)
    private Integer resultExperimentId;

    @ExcelProperty(value = "实验结果-物理页号序列", index = 14)
    @ColumnWidth(25)
    private String physicalPageNumberSequenceJson;

    @ExcelProperty(value = "实验结果-内存地址序列", index = 15)
    @ColumnWidth(25)
    private String memoryAddressSequenceJson;

    @ExcelProperty(value = "实验结果-单次存取时间序列", index = 16)
    @ColumnWidth(25)
    private String singleAccessTimeSequenceJson;

    @ExcelProperty(value = "实验结果-TLB命中状态序列", index = 17)
    @ColumnWidth(25)
    private String tlbHitStatusSequenceJson;

    @ExcelProperty(value = "实验结果-驻留内存集序列", index = 18)
    @ColumnWidth(25)
    private String residentMemorySetSequenceJson;

    @ExcelProperty(value = "实验结果-TLB命中率", index = 19)
    @ColumnWidth(15)
    private Double tlbHitRate;

    @ExcelProperty(value = "实验结果-缺页次数", index = 20)
    @ColumnWidth(15)
    private Integer pageFaultCount;

    @ExcelProperty(value = "实验结果-页面置换次数", index = 21)
    @ColumnWidth(18)
    private Integer pageReplacementCount;

    @ExcelProperty(value = "实验结果-缺页率", index = 22)
    @ColumnWidth(15)
    private Double pageFaultRate;

    @ExcelProperty(value = "实验结果-页面命中率", index = 23)
    @ColumnWidth(15)
    private Double pageHitRate;

    @ExcelProperty(value = "实验结果-实际运行时间(ms)", index = 24)
    @ColumnWidth(20)
    private Long realRunningTime;

    @ExcelProperty(value = "实验结果-模拟时间", index = 25)
    @ColumnWidth(15)
    private Integer emulateRunningTime;

    @ExcelProperty(value = "实验结果-平均实际时间(ms)", index = 26)
    @ColumnWidth(22)
    private Double averageRealRunningTime;

    @ExcelProperty(value = "实验结果-结果创建时间", index = 27)
    @ColumnWidth(22)
    @DateTimeFormat("yyyy-MM-dd HH:mm:ss")
